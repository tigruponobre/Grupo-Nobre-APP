...
function checkAuthorizedUser() {
    if (sessionStorage.getItem('unauthorized') == 'true') {
        if (window.innerWidth > 1180) {
            ...
            // authNotification.innerHTML = '<img src="./img/icons/warning.png" alt="warning" width="20px"><h3>Você não está autorizado a visualizar o painel administrativo, por gentileza, efetue o <b id="notificationLogin">login como administrador!</b></h3>'
            // document.querySelector('body').insertBefore(authNotification, document.querySelector('header'))
            window.alert('Você não está autorizado a visualizar o painel administrativo, por gentileza, efetue o login como administrador!')
        } else {
