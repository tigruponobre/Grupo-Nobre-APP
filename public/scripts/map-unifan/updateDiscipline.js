...
let editAndar = document.querySelector('.editAndar')
...
function editRow(event){
    ...
    editAndar.value = thisRowData[4].textContent
...
function editRowMobile(event){
    ...
    editAndar.value = thisRowNecessaryData[7].textContent
...
async function submitEdit(){
    ...
    //Fetch
    let response = await fetch(url + '/.netlify/functions/update_discipline_unifan', {
        method: 'put',
        body: JSON.stringify({
            curso: beforeCurso,
            turno: beforeTurno,
